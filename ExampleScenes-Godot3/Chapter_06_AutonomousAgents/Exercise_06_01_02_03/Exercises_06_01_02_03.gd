...
func _ready():
	randomize()
	target = Vector2(randf_range(0, viewport_size.x), randf_range(0,viewport_size.y))
	var ex1 = Vehicle_e06_01.new(Vector2(randf_range(0, viewport_size.x), randf_range(0,viewport_size.y)), 10)
	var ex2 = Vehicle_e06_01.new(Vector2(randf_range(0, viewport_size.x), randf_range(0,viewport_size.y)), 10)
	var contrast_ex2 =  Vehicle_e06_01.new(Vector2(randf_range(0, viewport_size.x), randf_range(0,viewport_size.y)), 10)
	var ex3 = Vehicle_e06_01.new(Vector2(randf_range(0, viewport_size.x), randf_range(0,viewport_size.y)), 10)
	add_child(ex1)
	add_child(ex2)
