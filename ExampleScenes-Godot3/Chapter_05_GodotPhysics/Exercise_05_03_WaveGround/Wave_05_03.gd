...
var final_wave_color = Color(1,1,1)
func _ready():
...
func _draw():
	var final_wave_array = PackedVector2Array([])
	...
	draw_colored_polygon(final_wave_array,final_wave_color)
	get_child(0).set_polygon(final_wave_array)
...
func _on_Wave_mouse_entered():
	final_wave_color= Color(0,0,0)
