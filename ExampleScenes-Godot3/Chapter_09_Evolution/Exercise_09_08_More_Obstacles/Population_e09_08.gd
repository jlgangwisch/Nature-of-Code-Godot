...
func _ready():
	...
	var o = get_parent().get_node("Obstacles")
...
func initialize_population():
	for i in range(population_num):
		var r = Rocket_e09_08.new(start_pos, lifetime)
		#population.append(r)
		add_child(r)
...
func reproduce(mating_pool):
	...
	var child = Rocket_e09_08.new(start_pos, lifetime)
