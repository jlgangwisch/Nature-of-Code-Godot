...
func initialize_population():
	for i in range(population_num):
		var r = Rocket_09_02.new(start_pos, lifetime)
		#population.append(r)
		add_child(r)
...
func selection():
	...
	for i in get_children():
		...
		if n>0:
			#print("adding", i, " ", n , " times")
			pass
		if n==0 && i.hit_target:
			print("fitness normalized: ", fitness_normal, ". distance to target: ", i.position.distance_to(target), i.hit_target)
		for j in n:
...
func reproduce(mating_pool):
	...
	var child = Rocket_09_02.new(start_pos, lifetime)
