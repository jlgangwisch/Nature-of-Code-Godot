...
class_name Position_Based_Dynamics_08_11

@export var is_stiff_body:bool = true
@export var is_tearable_body:bool = false

@export var compress_stiffness:= 0.9
@export var stretch_stiffness := 0.9
...
func add_vertex( new_position:Vector2 = Vector2( 300.0, 300.0 ), is_static:bool = false, new_mass:float = 1.0 ):
	var new_point_mass := PointMass_08_11.new() as PointMass_08_11
	...
	return new_point_mass

func add_spring( vertex_1, vertex_2, new_compress, new_stretch, length  ):
	var link := Distance_Constraint_08_11.new()
	(link as Distance_Constraint_08_11).initialize( vertex_1, vertex_2,length) 
